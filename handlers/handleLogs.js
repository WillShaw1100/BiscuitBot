...
function send_log(bot, guildId, embed) {
        const {client} = bot
...
function events(bot){
        ...
        client.on("messageDelete", function (message) {
            ...
            return send_log(bot, message.guild.id, embed);
        });
        ...
        client.on("guildChannelTopicUpdate", (channel, oldTopic, newTopic) => {
            ...
            return send_log(bot, channel.guild.id, embed);
        ...
        client.on("unhandledGuildChannelUpdate", (oldChannel, newChannel) => {
            ...
            return send_log(bot, oldChannel.guild.id, embed);
        ...
        client.on("guildBoostLevelUp", (guild, oldLevel, newLevel) => {
            ...
            return send_log(bot, guild.id, embed);
        ...
        client.on("rolePositionUpdate", (role, oldPosition, newPosition) => {
            ...
            return send_log(bot, role.guild.id, embed);
